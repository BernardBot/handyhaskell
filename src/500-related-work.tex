...
In this chapter we have given an explanation of what a monad does. We have shown two monads that are the basis for command trees and we shortly discussed how monads can be used to create a modular denotational semantics.