...
In this chapter we have given an explanation of the operational view of a monad. We have shown that the operational monad and the free monad are the basis for command trees and we shortly discussed how monads can be used to create a modular denotational semantics.