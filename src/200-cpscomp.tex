...
% TODO
We continue with the example from the previous section. The only change is that the function \icode{.f6} has been hoisted to the top level.
...
(module  
  ...
  (func $.start (result i32) (local $.f2_C i32) (local $.r0_C i32)  
    ...
    (global.set $.heap_pointer (i32.add (global.get $.heap_pointer) (i32.const 4)))
    (return_call_indirect (type $.t3) (local.get $.f2_C) (i32.const 41) (local.get $.r0_C) (i32.const 1))
  )
  (export ".start" (func $.start))
  (func $.r0 (param $.env i32) (param $.x1 i32) (result i32)  
    (local.get $.x1)
  )
  (func $.f2 (param $.env i32) (param $x i32) (param $.k3 i32) (result i32) (local $.x4 i32) (local $.k3_F i32)  
