...
%-- TODO: ref appendix
Two programs will be used as running examples throughout this thesis to show how the compilation process works. Their representation in different stages of the compiler can be found in appendix \ref{apdx:a}. In the \icode{Lam} language they are written as follows.
