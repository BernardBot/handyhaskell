...
In this chapter we have discussed how LamToWat is tested and how the performance of the two versions of the compiler compare. We also discussed other compiler transformations that are not included in the current version of LamToWat.